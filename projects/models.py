...
class Bus(TopologyNode):
    ...
    input_ports = models.IntegerField(null=True, default=1)
    output_ports = models.IntegerField(null=True, default=1)


class ConnectionLink(models.Model):
    bus = models.ForeignKey(Bus, on_delete=models.CASCADE, null=False)
    bus_connection_port = models.IntegerField(null=True, default=1)
