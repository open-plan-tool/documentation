...
urlpatterns = [
    ...
    path('project/update/<int:id>',
         project_update, name='project_update'),
    path('project/detail/<int:id>',
         project_detail, name='project_detail'),
    path('project/delete/<int:id>',
    ...
    path('scenario/update/<int:id>',
         scenario_update, name='scenario_update'),
    path('scenario/delete/<int:id>',
         scenario_delete, name='scenario_delete'),
